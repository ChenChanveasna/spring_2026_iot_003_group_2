...
static esp_err_t capture_download_handler(httpd_req_t *req)
{
...
void startCameraServer()
{
    ...
    .uri = "/capture_download",
    .method = HTTP_GET,
    .handler = capture_download_handler,
    .user_ctx = NULL
    };
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK)
    {
        ...
        httpd_register_uri_handler(camera_httpd, &capture_download_uri);
    }
